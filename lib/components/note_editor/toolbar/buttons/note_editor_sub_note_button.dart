...
class NoteEditorSubNoteButton extends StatelessWidget {
  ...
  onPressed: () {
    String subNoteKey = noteEditingController.note.generatedSubNoteKey();
    noteEditingController.note.subNotes[subNoteKey] = NoteEditingController(note: Note.createdNote("!SubNote"));
