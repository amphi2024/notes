    ...
    return Column(
      children: [
        ...
        Row(
          ...
          child: IconButton(icon: Icon(Icons.arrow_circle_left, size: 40,), onPressed: () {
               setState(() {
               pageController.animateToPage(pageController.page!.round() - 1, duration: Duration(milliseconds: 750), curve: Curves.easeOutQuint);
            });
        })
        ),
            SizedBox(
              ...
              child: PageView.builder(
                ...
                Visibility(
          visible: Platform.isLinux || Platform.isMacOS || Platform.isWindows,
          child: IconButton(icon: Icon(Icons.arrow_circle_right, size: 40,), onPressed: () {
            setState(() {
               pageController.animateToPage(pageController.page!.round() + 1, duration: Duration(milliseconds: 750), curve: Curves.easeOutQuint);
            });
